		...
		<view class="content">
			...
			<view v-show="current === 1">
				<uni-list>
					...
					<uni-list-item title="整数" note='数值框,如本示例中的"体重"' rightText="int" />
					<uni-list-item title="数组" note='如:单选/多选框,如本示例中的"喜欢的书"和"体重"' rightText="array" />
					<uni-list-item title="布尔值" note='如:开关switch,如本示例中的"是否党员"' rightText="bool" />
