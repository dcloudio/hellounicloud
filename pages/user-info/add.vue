	...
	<view class="uni-container">
		<uni-forms ref="form" :value="formData" validate-trigger="submit" err-show-type="toast">
			<uni-forms-item name="username" label="真实姓名">
				<uni-easyinput placeholder="限制只能输入中文" v-model="formData.username" />
			</uni-forms-item>
			...
			<uni-forms-item name="mobile" label="手机号码">
				<uni-easyinput placeholder="手机号码" v-model="formData.mobile" />
			</uni-forms-item>
			...
			<uni-forms-item name="address_code" label="地址">
				<uni-data-picker self-field="code" parent-field="parent_code" v-model="formData.address_code" collection="opendb-city-china"
			...
			<uni-forms-item name="comment" label="备注">
				<textarea @input="binddata('comment', $event.detail.value)" class="uni-textarea-border" :value="formData.comment"></textarea>
			</uni-forms-item>
	...
	export default {
		data() {
			return {
				...
				rules: {
					...getValidator(["username", "gender", "birth_date", "weight", "mobile", "email", "url", "favorite_book_id",
						"address_code", "party_member", "hobby", "comment"
					])
				}
			}
		},
