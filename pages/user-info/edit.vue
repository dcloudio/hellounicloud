  ...
  "hobby_localdata": [
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field('username,gender,birth_date,weight,mobile,email,url,favorite_book,address,party_member,hobby,comment').get().then((res) => {
